function [ TAC_ReferenceVOI ] = extractTACFromReferenceRegions( image4D, referenceVOI, numberOfFrames )
...
TAC_ReferenceVOI = sumFrames(TAC_ReferenceVOI,numberOfFrames);
