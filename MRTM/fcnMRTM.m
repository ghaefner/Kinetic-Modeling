function [ bindingPotentials ] = fcnMRTM( pathInputImage, pathReferenceVOI, timepoints, startFrame )
...
parfor i = 1:xDim
    for j = 1:yDim
        for k = 1:zDim            
            ...
            bindingPotentials(i,j,k) = calcMRTM(timepoints,startFrame,TAC,TAC_ReferenceVOI,IntegralsOfActivityInRegion,IntegralsOfActivityInVoxel);        
        end
    end
end
